...
class EventChallengesScreen extends StatelessWidget {
  ...
  final bool isTeam;
  const EventChallengesScreen({super.key, required this.eventModel, required this.isTeam});
            ...
            Padding(
              ...
              child: Container(
                  decoration: BoxDecoration(
                    ...
                    child: SizedBox(
                      height: 800,
                      child: Consumer<ChallengesFetchProvider>(
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return Column(
                                children: [
                                  OptionItem(
                                      optionName: value.challenges[index].challenge_name,
                                      optionDescription: value.challenges[index].challenge_discreption),
                                  Padding(
